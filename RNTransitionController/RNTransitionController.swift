...
public class RNTransitionController: NSObject {
  ...
  public func present(viewController presentedViewController: UIViewController,
                      ...
                      animation: RNTransitionAnimation,
                      completion: (() -> Void)? = nil) {
  ...
  public func present(viewController presentedViewController: UIViewController,
    ...
    self.present(viewController: presentedViewController,
...
extension RNTransitionController: UIViewControllerAnimatedTransitioning {
  ...
  public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
    ...
    if let firstView = firstViewController?.view,
      ...
      case .coverVertical:
        self.coverVerticalAnimation(with: transitionContext,
                                    containerView: containerView,
                                    firstView: firstView,
                                    secondView: secondView)
        
      case .coverHorizontal:
        self.coverHorizontalAnimation(with: transitionContext,
                                      containerView: containerView,
                                      firstView: firstView,
                                      secondView: secondView)
        
      case .fadeIn:
        self.fadeInAnimation(with: transitionContext,
                             containerView: containerView,
                             firstView: firstView,
                             secondView: secondView)
        
      case .fadeInWithSubviewZoomIn:
        self.fadeInWithSubviewZoomInAnimation(with: transitionContext,
                                              containerView: containerView,
                                              firstView: firstView,
                                              secondView: secondView,
                                              subviewTag: self.subviewTag)
        
      case .slideIn:
        self.slideInAnimation(with: transitionContext,
                              containerView: containerView,
                              firstView: firstView,
                              secondView: secondView)
        
      case .slideFromTopToBottom:
        self.slideFromTopToBottom(with: transitionContext,
                                  containerView: containerView,
                                  firstView: firstView,
                                  secondView: secondView)
      }
...
private extension RNTransitionController {
  ...
  private func coverVerticalAnimation(with transitionContext: UIViewControllerContextTransitioning,
  ...
  private func coverHorizontalAnimation(with transitionContext: UIViewControllerContextTransitioning,
                                        containerView: UIView,
                                        firstView: UIView,
                                        secondView: UIView) {
  ...
  private func fadeInAnimation(with transitionContext: UIViewControllerContextTransitioning,
                               containerView: UIView,
                               firstView: UIView,
                               secondView: UIView) {
  ...
  private func fadeInWithSubviewZoomInAnimation(with transitionContext: UIViewControllerContextTransitioning,
                                                containerView: UIView,
                                                firstView: UIView,
                                                secondView: UIView,
                                                subviewTag: Int) {
  ...
  private func slideInAnimation(with transitionContext: UIViewControllerContextTransitioning,
                                containerView: UIView,
                                firstView: UIView,
                                secondView: UIView) {
  ...
  private func slideFromTopToBottom(with transitionContext: UIViewControllerContextTransitioning,
                                    containerView: UIView,
                                    firstView: UIView,
                                    secondView: UIView) {
